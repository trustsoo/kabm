...
jQuery(document).ready(function(){
	jQuery('#user_nm').keyup(function() {
		var inputVal = jQuery(this).val();
		jQuery(this).val((inputVal.replace(/[ㄱ-힣~!@#$%^&*()_+|<>?:{}= ]/g,'')));
	});
...
{
	var url = '/member/signUp.jspx?cmd=join_step_5';
...
<body>
	...
	<div id="content">
			...
			<!-- 개인회원 스탭 -->
				...
				<li><img src="/static/main/img/sub/join_tab_2_1_off.jpg"  alt="약관동의" /></li>
			<%}%>
			<% if( MEM_DIV_CORP.equals(mem_div)){ %>
			<!-- 법인회원  스탭 -->
				<li><img src="/static/main/img/sub/join_newtab_1_3_1.jpg"  alt="법인회원" /></li>
				<li><img src="/static/main/img/sub/join_tab_2_2_off.jpg"  alt="약관동의" /></li>
			<%}%>
		...
		<div class="section-1 padding_15"  id="divE" style="display:none;">
			<div class="con_600">
				...
				<p>수신가능한 본인 이메일로 인증번호를 보내드립니다.</p>
						...
						<tbody>
							...
							<tr>
								...
								<td colspan="3">
									...
									<span style="font-weight:bold;color:red;">* 영문 숫자만 가능</span>
								</td>
							</tr>	
							<tr>
								<th scope="row" >성별</th>
