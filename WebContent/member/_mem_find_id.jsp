...
function lf_idFinderSms()
{
	...
	var http = jQuery.ajax( {
		url: "/member/action/memberAction.jspx?cmd=idFinderSms",
   		type: "POST",
...
function lf_idFinderEmail()
{
	...
	var http = jQuery.ajax( {
		url: "/member/action/memberAction.jspx?cmd=idFinderEmail",
   		type: "POST",
	...
	$.ajax({
		...
		success:function(data){
			if( data.iRtn == "0") {
				...
				{
					jQuery('#txt_userId').html(sUserId);
					jQuery('#txt_idbox').show();
					msgOpen( '회원님 아이디는 [<b style="color: red;font-weight:bold;">'+sUserId+'</b>] 입니다.' );
				}else{
					msgOpen( msg_mem_code_008 );
				}
			}else {
...
<body>
	...
	<div class="pageTit">
		<h2><span class="tit_1">ID 찾기</span></h2>
		<p class="rTxt">
			아이디 찾는 방법을 선택해주세요.
		</p>
	</div>
	<div id="content">
		<div class="section-1 padding_15">
			<div class="con_600">
				...
				<p>회원정보에 등록한 휴대전화 번호로 아이디를 받아 보실 수 있습니다.</p>
					...
					<table cellpadding="0" cellspacing="0" class="" summary="" >
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<a href="javascript:lf_idFinderSms();" class="pbtn02 mid"><span class="">아이디확인</span></a>
								</td>
							</tr>
							<tr>
								<th scope="row"></th>
		...
		<div class="section-1 padding_15">
			<div class="con_600">
				...
				<p>회원정보에 등록한 이메일로 아이디를 받아 보실 수 있습니다.</p>
					...
					<table cellpadding="0" cellspacing="0" class="" summary="" >
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<a href="javascript:lf_idFinderEmail();" class="pbtn02 mid"><span class="">아이디확인</span></a>
								</td>
							</tr>							
						</tbody>
					</table>
		...
		<div class="section-1 padding_15">
			<div class="con_600">
				...
				<p>등록한 회원정보로 찾기 어려우시면, 본인 확인 후 아이디를 찾아드립니다.</p>
				
				<div class="form" id="div_3" >
					<div class="ment">
						개인정보보호를 위해 주민등록번호 대신 모바일 인증으로 신원을 확인합니다.<br />
						아래의 모바일 인증을 받으시면 아이디를 확인하실 수 있습니다.
					</div>
		...
		<div id="txt_idbox" style="display:none;position: relative;margin-top: 10px;width:100%;border: 1px solid #eff2e3;background: #f8faf4;padding: 8px 19px;text-align: center;">
			<dl class="enter_info">
				<dt>회원님 아이디는 [<b id="txt_userId" style="color: red;font-weight:bold;"></b>] 입니다.
				</dt>
			</dl>
		</div>
	</div>
