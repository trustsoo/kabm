...
{
	var url = '/member/join.jspx?cmd=join_step_6';
...
<input type="hidden" name='email' id='email' value=''/>
	...
	<div id="content">
			...
			<%}%>
				...
				<li class="on"><img src="/static/main/img/sub/join_tab_5_on.jpg"  alt="기본정보입력" /></li>
			...
			<div class="view">
				<table cellpadding="0" cellspacing="0" class="" summary="" >
					...
					<tbody>
						<tr>
							<th scope="row" class="on">성명 <i class="fa fa-asterisk tred"></i>  </th>
							<td>
						...
						<tr>
							...
							<td>
								<input type="text" class="it " title="아이디" value="" name='user_id' id='user_id' required='true' onkeyup="checkAlphaNum(this)"/>
								<a href="javascript:lf_idConfirm();" class="pbtn03 mini"><span class="">ID 중복확인</span></a><span style="font-weight:bold;color:red;">*영어 소문자와 숫자만 사용 가능합니다.</span>
							</td>
						</tr>
						<tr>
						...
						<!-- <tr>
							...
							<td>
								<input type="text" class="it lag" title="무통장입금 시 입금자명" value="" name='account_nm' id='account_nm' />
							</td>
						</tr> -->
						<% if(!"E".equals(cert_div)){ %>
						<tr>
							...
							<td>
								...
								<% if( MEM_DIV_NEW.equals(mem_div)){ %> <span style="font-weight:bold;color:red;">*로그인하신 후 [정보변경]에서 변경 가능합니다.</span><%} %>
							</td>
						</tr>
						<%} %>
						<% if("E".equals(cert_div)){ %>
						...
						<tr>
							...
							<td>
								<input type="text" class="it " readonly="readonly" title="자택주소 우편번호" value="" name='zipcode' id='zipcode' alt='자택주소-우편번호' required='true'/>
								<a href="#" class="pbtn01 mini" id='btn_addrSel'><span class="">선택</span></a>
							</td>
						</tr>
						<tr>
							<td>
								<input type="text" class="it long" title="자택주소" value="" name='addr' id='addr' alt='자택주소' required='true'/>
							</td>
						</tr>
