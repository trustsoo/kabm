...
(function($) {
		...
		return {
			...
			rename : function (obj, new_name) {
				...
				if((typeof new_name).toLowerCase() == "string") {
					...
					_this.inp = $("<input type='text' autocomplete='off' maxlength='30' />");
					_this.inp
	...
	$(function () {
		...
		if(/msie/.test(u) && !/opera/.test(u)) {
			//2010.03.10 edited by advan94 . cause : node overlap...
			...
			if(parseInt(v) == 6) css += '.tree li { zoom:1; } .tree li li { overflow:visible; } .tree .ltr li.last { margin-top: expression( (this.previousSibling && /open/.test(this.previousSibling.className) ) ? "-2px" : "0"); } .marker { width:45px; background-position:-32px top; } .marker_plus { width:5px; background-position:right top; }';
			...
			if(parseInt(v) == 8) css += '.tree li li { overflow:visible; } .tree .ltr li.last { margin-top: expression( (this.previousSibling && /open/.test(this.previousSibling.className) ) ? "-2px" : "0"); }';
		}
