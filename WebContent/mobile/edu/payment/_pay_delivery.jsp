...
<body>			
<form name="frm_mem" id="frm_mem" method="post" action="/mobile/edu/payment/paymentCtrl.jspx?cmd=paymentReq" >
...
<div class="popupLayer" style="">
	...
	<div class="popupCont_bottom " style="height: 695px;font-size: 14px;">
			...
			<div style="font-weight:bold;color:#1e90f1;margin-top:20px;">▣  교재배송지 선택</div>
			<div class="view row" style="margin-top: 10px;">								
                ...
                <input type="radio" class="flat" name="deliverySel" id="newSel"  value="NEW" /> 신규배송지
			</div>
			
			<div style="font-weight:bold;color:#1e90f1;margin-top:20px;">▣  교재배송지 정보</div>
			<div id="DIVCORP" style="display:block;margin-top: 10px;">
				<table class="table table-striped jambo_table bulk_action">
					...
					<tbody>
						<tr class="even pointer">
							...
							<td class=" last">${output.user_nm }</td>
						</tr>
						<tr class="even pointer">
							<td class="a-center ">연락처</td>
							<td class=" last">${output.tel_no }</td>
						</tr>
						<tr class="even pointer">
							<td class="a-center ">회사주소</td>
							<td class=" last">(${output.cpost }) ${output.addr_nm }</td>
						</tr>
					</tbody>
				</table>
			</div>
			...
			<div id="DIVHOME" style="display:none;margin-top: 10px;">
				<table class="table table-striped jambo_table bulk_action">
					<colgroup>
						<col width="80px"/><col width=""/>
					</colgroup>
					...
					<tbody>
						...
						<tr class="even pointer">
							<td class="a-center ">자택주소</td>
							<td class=" last">(${output.zipcode }) ${output.addr }</td>
						</tr>
					</tbody>
				</table>				
			</div>
			...
			<div id="DIVNEW" style="display:none;margin-top: 10px;">
				<table class="table table-striped jambo_table bulk_action">
					<colgroup>
						<col width="80px"/><col width=""/>
					</colgroup>
				...
				<div style="margin-top: 10px;">
					<label for="post_req" class="">연락처2</label>
					<div class="form-group row">								
						<div class="col-md-12 col-sm-12">
							<div class="input-group">
							<select class="form-control" style="width:80px;" name='post_tel_no1' id='post_tel_no1'>
							...
							<input type="text" class="form-control " style="width:100px;margin-left:2px;" maxlength="4" title="연락처2" value="" name='post_tel_no2' id='post_tel_no2' />
							<input type="text" class="form-control " style="width:100px;margin-left:2px;" maxlength="4" title="연락처2" value="" name='post_tel_no3' id='post_tel_no3' />
							</div>
						</div>	
					</div>
				</div>
				...
				<div style="margin-top: 20px;">
					<label for="new_post_zipcode" class="">교재수령지 <i class="fa fa-asterisk tred"></i></label>
					<div class="form-group row">
						<div class="col-md-12 col-sm-12">
							<div class="input-group" style="width:50%">
								<input type="text" class="form-control " readonly="readonly" title="교재수령지우편번호" value="${output.post_zipcode }" name='new_post_zipcode' id='new_post_zipcode' alt='교재수령지우편번호' required='true'/>
								<span class="input-group-btn">
								<a id="btn_postSel" class="btn btn-default">선택</a>
								</span>
							</div>										
						</div>						
					</div>
					<div class="form-group row">
						<div class="col-sm-12" style="width:100%;">
							<input type="text" class="form-control " title="교재수령지" value="${output.post_addr }" name='new_post_addr' id='new_post_addr' alt='교재수령지' required='true'/>
						</div>	
					</div>
				</div>
			...
			<div style="margin-top: 20px;">
				<label for="post_req" class="">배송시 요청사항</label>
				<div class="form-group row">								
					<div class="col-sm-12" style="width:100%;">
						<input type="text" class="form-control " title="배송시 요청사항" value="" name='post_req' id='post_req' alt='배송시 요청사항'/>
					</div>
				</div>
			</div>
			<div class="actionBar btnWrap">
				<a id='btn_reg' class="btn btn-success">다음</a>
...
<div id="viewForm" style="border-left: 1px solid #1e90f1;border-right: 1px solid #1e90f1;z-index: 999;width:100%;display: none;position:absolute;left:0px;top:-47px;background-color: #FFF;">
	...
	<table class="table table-striped jambo_table bulk_action">
		...
		<tbody>
			<tr class="even pointer">
				<td class="a-center ">성 명</td>
				<td class=" last" id="txt_user_nm">${output.user_nm }</td>
			</tr>
			<tr class="even pointer">
				<td class="a-center ">연락처</td>
				<td class=" last" id="txt_tel_no">${output.tel_no }</td>
			</tr>
			<tr class="even pointer">
				<td class="a-center ">연락처2</td>
				<td class=" last" id="txt_post_tel_no"></td>
			</tr>
			<tr class="even pointer">
				<td class="a-center ">교재 수령지</td>
				<td class=" last" id="txt_new_post_addr"></td>
			</tr>
			<tr class="even pointer">
				<td class="a-center ">배송지 요청사항</td>
				<td class=" last" id="txt_post_req"></td>
			</tr>
			<tr class="even pointer">
			...
			<tr class="even pointer">
				<td class=" last" id="txt_post_req" colspan="2" style="color:red;font-weight:bold;">
					□ 배송지 주소를 정확하게 입력해 주시기 바라며, 반송될 경우 착불로 수령 가능합니다.
				</td>
			</tr>
			<tr class="even pointer">
				<td class=" last" id="txt_post_req" colspan="2" style="color:red;font-weight:bold;">
					□ [위생교육 → 결제내역]에서 배송지 수정이 가능하나 발송 처리된 이후로는 수정 불가하며, 송장번호도 조회하실 수 있습니다.
				</td>
			</tr>
		</tbody>
	</table>
	<div class="actionBar">
		<a id='btn-save' class="btn btn-success">다음</a>
...
jQuery(document).ready(
		function()
		{	
			jQuery('#mobileTitle').html('교재배송지 입력');
