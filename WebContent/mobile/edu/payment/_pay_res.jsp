	...
	try
	{
		...
		boolean isInitOK = xpay.Init(configPath, CST_PLATFORM);
	   	...
	   	if( !isInitOK ) {
	        ...
	        sb.append( "토스페이먼츠에서  제공한 환경파일이 정상적으로 설치 되었는지 확인하시기 바랍니다.<br>");
	        sb.append( "mall.conf에는 Mert ID = Mert Key 가 반드시 등록되어 있어야 합니다.<br><br>");
	        sb.append( "문의전화 토스페이먼츠 1544-7772<br>");
...
<div class="popupLayer" style="">
	<div style="font-size:1.5em;font-weight:bold;color:#1e90f1;margin-top:20px;">▣  결제가 완료 되었습니다.</div>
	<div class="popupCont_bottom " style="height: 695px;">
		<table class="table table-striped jambo_table bulk_action">
			...
			<tbody>
				<tr class="even pointer">
					<td class="a-center ">결제번호</td>
					<td class=" last"><%= LGD_OID %></td>
				</tr>
				<tr class="even pointer">
					<td class="a-center ">결제내역</td>
					<td class=" last"><%= input.getText("LGD_PRODUCTINFO")  %></td>
				</tr>
				<tr class="even pointer">
					<td class="a-center ">결제승인금액</td>
					<td class=" last"><%= LGD_AMOUNT %></td>
				</tr>
				<tr class="even pointer">
					<td class="a-center ">결제결과메시지</td>
					<td class=" last"><b><%=LGD_RESPMSG%></b>
					</td>
				</tr>				
			</tbody>
		</table>
		...
		<strong class="">* <% if( issuccess ){ %>
						나의강의실로 이동하여 동영상을 수강하시기 바랍니다.					
					<% }%></strong>
		</div>
		<div class="btnWrap center">
			<a href="javascript:fn_reload();" class="btn btn-success">확인</a>
		</div>
...
<% if( issuccess ){ %>
	alert( '나의강의실로 이동하여 동영상을 수강하시기 바랍니다.' );
...
function fn_reload()
{
	...
	opener.location = '/mobile/edu/payment/paymentCtrl.jspx?cmd=viewPaymentList';
	self.close();
}
