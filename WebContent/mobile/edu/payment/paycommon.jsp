...
String configPath = "C:/repository/git/kabm/WebContent/edu/lgdacom";  //LG텔레콤에서 제공한 환경파일("/conf/lgdacom.conf,/conf/mall.conf") 위치 지정.
...
try
{
	if(thisServerName == null || "".equals(thisServerName))
	{
		...
		String confServerName = conf.getString("domain");
		domain = confServerName;
	}else{
...
try
{
	LGD_RETURNURL = "https://" + domain + "/mobile/edu/payment/paymentCtrl.jspx?cmd=paymentCertKey";
}catch(Exception e ){}
 ...
 */
 ...
 String LGD_OSTYPE_CHECK = "M";               //결제모듈이  PC에서만 실행되게 처리
