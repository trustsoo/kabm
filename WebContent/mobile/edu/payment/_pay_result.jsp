...
<div class="popupLayer" style="">
	...
	<div class="popupCont_bottom " style="height: 695px;">
		<table class="table table-striped jambo_table bulk_action">
			...
			<tbody>
				<tr class="even pointer">
					<td class="a-center ">입금자성명</td>
					<td class=" last"><%=result.getText("LGD_PAYER")%></td>
				</tr>
				<tr class="even pointer">
					<td class="a-center ">입금은행</td>
					<td class=" last"><%=result.getText("LGD_FINANCENAME")%></td>
				</tr>
				<tr class="even pointer">
					<td class="a-center ">입금계좌</td>
					<td class=" last"><%=result.getText("LGD_ACCOUNTNUM")%></td>
				</tr>
				<tr class="even pointer">
		...
		<strong class="">* 결제가 완료되었습니다. 아래 확인 버튼을 눌러 결제 내역을 확인하시기 바랍니다.</strong>
		</div>
