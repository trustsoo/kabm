...
<div class="popupLayer" style="">
	...
	<div class="popupCont_bottom " style="height: 695px;font-size: 14px;">
			...
			<div style="font-weight:bold;color:#1e90f1;margin-top:20px;">▣  ${ input.product_nm } 교재</div>
			...
			<div style="margin-top: 20px;">
				...
				<div class="form-group row">								
					<div class="col-sm-12" style="width:100%;">
						<input type="text" class="form-control " title="배송시 요청사항" value="${output.post_req }" name='post_req' id='post_req' alt='배송시 요청사항'/>
					</div>
				</div>
			</div>
