	...
	<div class="tab-content" id="myTabContent">
		<div class="tab-pane fade active in" id="home" role="tabpanel" aria-labelledby="home-tab">
			...
			<input type="hidden" name="tel_no" id="tel_no">
				...
				<div class="x_content">
					...
					<a href="javascript:lf_idFinderSms();" class="btn btn-primary"><span class="">아이디확인</span></a>
				</div>
			</div>											
		</div>
		<div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
			...
			<div class="form" id="div_2" >
				...
				<div class="x_content">
					<a href="/mobile/login.jsp" class="btn btn-default">취소</a>
					<a href="javascript:lf_idFinderEmail();" class="btn btn-primary"><span class="">아이디확인</span></a>
				</div>	
...
jQuery(document).ready(function(){
	...
	jQuery('#mobileTitle').html('아이디 찾기');
});
