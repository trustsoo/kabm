...
{	
	...
	if ( code == "200")
	{
		...
		jQuery(xmlDoc).find('corp_info').each(function(){
			...
			var corpHTML = "<div style='WIDTH:180px;' class='ellipsis'><a href='javascript:fn_setCorpInfo(\"" + corp_reg_no + "\",\"" + corp_nm + "\",\"" + cp_code + "\",\"" + ill_no + "\",\"" + addr_nm + "\",\"" + mb_no + "\",\"" + rprstt_kr + "\")' >" + corp_nm +"</a></div>";
			var addrHTML = "<div style='WIDTH:300px;' class='ellipsis'><a href='javascript:fn_setCorpInfo(\"" + corp_reg_no + "\",\"" + corp_nm + "\",\"" + cp_code + "\",\"" + ill_no + "\",\"" + addr_nm + "\",\"" + mb_no + "\",\"" + rprstt_kr + "\")' >" + addr_nm +"</a></div>";
		...
		if( i <= 0 || j<=1)
		{
			...
			listHtml.push('		<tr>');
			listHtml.push('		  <td colspan="4" style="text-align:center;font-weight:bold;color:red;">'+msgTxt+'</td>');
			listHtml.push('		</tr>');
	...
	<table class="condition-table">
		<tbody>
			<tr>
				...
				<td>
					<input type="text" class="form-control" name="title" id="title" value="${input.title }" style="width:250px;" />
				</td>
...
<div class="directions">
	<table cellpadding="0" cellspacing="0" class="" summary="" >
		<tbody>
			<tr>
				<th rowspan="2" scope="row">주의사항</th>
				<td>
