...
%>
	...
	<link rel="stylesheet" href="/static/com/css/common.css?_dummy=<%=_dummy %>" />
	<link rel="stylesheet" type="text/css" href="/static/com/css/royalslider/royalslider.css"/>
	<link rel="stylesheet" type="text/css" href="/static/com/css/royalslider/skins/default/rs-default.css"/>
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js"></script>
	<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-easing/1.3/jquery.easing.min.js"></script>
	<script type="text/javascript" src="/static/com/css/royalslider/jquery.royalslider.min.js"></script>
	<script type="text/javascript" src="/static/com/js/TweenMax.min.js"></script>
	<!--[if lt IE 9]>
