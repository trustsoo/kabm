...
function fn_next( div )
{
	...
	if(div == 1) 
		location.href = '/edu/lecture/offlineCtrl.jspx?cmd=offlineLecture';
	else{
...
<div id="content">		
	...
	<div class="mypage">
		<div class="section-1">
			<ul class="applybtns">
				<li class="">
					<strong>집합교육 신청하기</strong>
					<p>
						<span style="font-weight:bold !important;">교육을 새로 신청하실 때 선택하세요</span>
					</p>
					<div class="">
						<a href="javascript:fn_next(1);" class="pbtn02"><span class="">신청하러가기</span></a>
					</div>
				</li>
				<li class="">
					<strong>신청내역 확인하기</strong>
					<p>
						<span style="font-weight:bold !important;">이전에 신청한 내역을 확인하거나 수정하실 때 선택하세요</span>
					</p>
					<div class="">
						<a href="javascript:fn_next(2);" class="pbtn02_1"><span class="">신청내역확인</span></a>
					</div>
				</li>
			</ul>
		</div>
