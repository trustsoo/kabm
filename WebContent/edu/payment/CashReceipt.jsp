...
<%
     ...
     */
    String CST_PLATFORM           = request.getParameter("CST_PLATFORM");                 //LG텔레콤 결제서비스 선택(test:테스트, service:서비스)
    String CST_MID                = request.getParameter("CST_MID");                      //LG텔레콤으로 부터 발급받으신 상점아이디를 입력하세요.
    ...
    String LGD_TID                = request.getParameter("LGD_TID");			  		  //텔레콤 거래번호 (취소시만 사용) 
