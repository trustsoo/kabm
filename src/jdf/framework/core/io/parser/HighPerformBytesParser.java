 ...
 * @version 1.1
 */
public final class HighPerformBytesParser implements BytesParser
{
			...
			for(int i=0; i<fieldCount; i++)
			{
				...
				else if (fieldClass.isArray() )
				{
                    ...
                    */
                    ...
                    int ArrayNum = (inputLength-total) / childLen;  //배열 갯수
		...
		try
		{
    		...
    		for (int i=0; i<fieldCount; i++)
    		{
    			...
    			// short
    				...
    				bytesBuffer.write ( getShortBytes( field[i].getInt( entity ) ));
