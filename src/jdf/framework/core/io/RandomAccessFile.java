// $Id: RandomAccessFile.java,v 1.1.1.1 2005/01/30 13:43:47 Exp $
/*
 ...
 *
 * @author Russ Rew
 * @version $Id: RandomAccessFile.java,v 1.1.1.1 2005/01/30 13:43:47 Exp $
 */
...
public class RandomAccessFile implements DataOutput, DataInput {
    ...
    *                               security exception.
    */
   private RandomAccessFile( String filename, int mode )
   throws IOException {
   ...
   public RandomAccessFile( String filename, String modeString, int bufferSize )
	...
	throws IOException {
	this(file.getPath(), modeString, bufferSize);
    }
    ...
    *                               security exception.
    */
   private RandomAccessFile( String filename, int mode, int bufferSize )
   throws IOException {
      this.mode = mode;
    ...
    */
   private static void testBytes( String filename, int bufferSize ) {
    ...
    * @param filename    the name of the test file to generate.
    */
   private static void testBlocks( String filename ) {
   ...
   private static void benchmark( String filename, int bufferSize ) {
      System.out.println( "\nBenchmarking..." );
