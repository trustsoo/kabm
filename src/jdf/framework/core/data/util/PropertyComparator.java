...
public class PropertyComparator implements Comparator
{
	...
	public int compare(Object o1, Object o2)
	{
		...
		try {
			...
			if (Logger.err.isPrintMode()) {
				Logger.err.println("Could not sort objects [" + o1 + "] and [" + o2 + "]", ex);
			}
			return 0;
		}
	...
	private Object getPropertyValue(Object obj)
	{
		...
		JavaBeanDataSet jds = new JavaBeanDataSet(obj);
		return jds.get(this.sortDefinition.getProperty());
	}
	...
	{
		if (StringUtil.hasText(sortDefinition.getProperty())) {
